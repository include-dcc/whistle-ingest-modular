...
def exec():
    ...
    report_count(
        fhir_client,
        f"Patient?_tag={args.study}&_summary=count",
    ...
    report_count(
        fhir_client,
        f"Group?_tag={args.study}&code=Proband-only&_summary=count",
        "Family Type.Proband-Only",
        summary,
    )
    report_count(
        fhir_client,
        f"Group?_tag={args.study}&code=Duo&_summary=count",
        "Family Type.Duo",
        summary,
    )
    report_count(
        fhir_client,
        f"Group?_tag={args.study}&code=Trio&_summary=count",
        "Family Type.Trio",
        summary,
    )
    report_count(
        fhir_client,
        f"Group?_tag={args.study}&code=Other&_summary=count",
        "Family Type.Other",
        summary,
    )
    report_count(
    ...
    report_count(
        fhir_client,
        f"Group?_tag={args.study}&code=Control-only&_summary=count",
    ...
    report_count(
        fhir_client,
        f"Observation?_tag={args.study}&_profile=https://nih-ncpi.github.io/ncpi-fhir-ig/StructureDefinition/family-relationship&value-concept=SIB&_summary=count",
        "Family Relationship.Sibling",
        summary,
    )
    report_count(
        fhir_client,
        f"Observation?_tag={args.study}&_profile=https://nih-ncpi.github.io/ncpi-fhir-ig/StructureDefinition/family-relationship&value-concept=MTH&_summary=count",
        "Family Relationship.Mother",
        summary,
    )
    report_count(
        fhir_client,
        f"Observation?_tag={args.study}&_profile=https://nih-ncpi.github.io/ncpi-fhir-ig/StructureDefinition/family-relationship&value-concept=FTH&_summary=count",
        "Family Relationship.Father",
        summary,
    )
    report_count(
        fhir_client,
        f"Observation?_tag={args.study}&_profile=https://nih-ncpi.github.io/ncpi-fhir-ig/StructureDefinition/family-relationship&value-concept=FAMMEMB&_summary=count",
